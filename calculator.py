...
clear = Button(btns_frame, text = "C", fg = "black", width = 32, height = 3, command = lambda: btn_clear()).grid(row = 0, column = 0, columnspan = 3)
divide = Button(btns_frame, text = "/", fg = "black", width = 10, height = 3, command = lambda: btn_click("/")).grid(row = 0, column = 3)
